    ...
    <div className="card">
      ...
      <ResponsiveContainer width="100%" height={240}>
        <LineChart data={data} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
          ...
          <Legend />
          <Line type="monotone" dataKey="progres" stroke="#237043" strokeWidth={2} dot={{ r: 4 }} name="Progres" />
          <Line type="monotone" dataKey="target" stroke="#b7cdc0" strokeWidth={2} strokeDasharray="5 5" dot={false} name="Target" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
